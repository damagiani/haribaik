        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden" style="background-image: url('{{ URL::asset('assets/img/signinimage.jpg') }}');
          background-size: cover;">
                <span class="mask bg-gradient-primary opacity-6"></span>
                <h2 class="mt-5 text-white font-weight-bolder position-relative">WangShui</h2>
                <p class="text-white position-relative">Hitung keberuntunganmu berdasarkan <span style="color: #FFCC00">Wariga Belog</span> dan <span style="color: #FFCC00">Fengshui</span></p>
              </div>
            </div>
          </div>
        </div>
